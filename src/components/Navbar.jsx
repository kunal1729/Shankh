  ...
  return (
    <div className='flex shadow-2xl top-0  z-10 items-center p-4 justify-between'>
      ...
      <div className='flex space-x-[32px] text-[#5F6C7B] cursor-pointer text-sm items-center'>
        ...
        <NavLink to={'/login'} style={{fontFamily : "Poppins"}} className='pt-[10px] pb-[10px] pr-[53px] pl-[53px] rounded-md text-sm w-[199px] font-semibold text-white bg-[#34856C] cursor-pointer'>Get Started</NavLink>
      </div>
    </div>
  )
}
