    ...
    <div id = 'Features' className='bg-[#F8FAFA] p-16 space-x-6 flex items-center sticky top-0 z-0 h-[97svh]'>
      ...
      <div className='space-y-8'>
        ...
        <div style={{fontFamily : "Poppins"}} className='flex content-center space-x-[32px]'>
            <button className='pt-[10px] text-[16px] pb-[10px] pl-[53px] pr-[53px] rounded-lg bg-[#FF6B5B] w-[199px] font-semibold text-white'>Get Started</button>
            <button className='border w-[199px] rounded-lg font-semibold pt-[10px] text-[16px] pb-[10px] pl-[53px] pr-[53px] text-[#34856C] border-[#34856C]'>Learn More</button>
        </div>
      </div>
      <div>
