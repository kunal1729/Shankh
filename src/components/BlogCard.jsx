...
const BlogCard = () => {
  return (
    ...
    {ourBlogs.map((item) => {
        ...
        return (
            <div className='w-[325px] transition-transform duration-500 ease-in hover:bg cursor-pointer rounded-3xl shadow-xl space-y-2  content-end h-[439px] p-2 text-[#F8FAFA]  bg-cover' style={{ backgroundImage: `url(${item.img})` }}>
