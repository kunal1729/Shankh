  ...
  return (
    <div className='flex flex-col justify-center space-y-24 items-center'>
        ...
        <div className='w-[650px] space-y-8'>
            ...
            <button style={{fontFamily : "Poppins"}} className='pt-[10px] text-[16px] pb-[10px] pl-[53px] pr-[53px] rounded-lg bg-[#FF6B5B] w-full font-semibold text-white'>Get in Touch</button>
        </div>
    </div>
  )
}
