    ...
    <div className='pl-[20px] space-y-4 h-[88svh] overflow-y-scroll bg-[#F8FAFA] pr-[20px] pt-[32px] pb-[20px]'>
        <div className='bg-white space-y-2 rounded-lg shadow-lg w-full pl-[24px] pt-[16px] pr-[24px] pb-[16px]'>
            <div className='flex justify-between items-center'>
                <div className='leading-8'>
                    ...
                    <span style={{fontFamily : "Inter"}} className='text-[14px] text-[#5F6C7B]'>Test ID : {selectedTest.testId} | {selectedTest.date}</span>
                </div>
                <button style={{fontFamily : "Poppins"}} className='flex space-x-2 pb-[10px] rounded-lg pl-[16px] pt-[10px] pr-[16px] bg-[#34856C] text-white '>
        ...
        <div className='bg-white space-y-8 rounded-lg shadow-lg w-full pl-[24px] pt-[16px] pr-[24px] pb-[16px]'>
            <div className='flex justify-between'>
                ...
                <span style={{fontFamily : "Poppins"}} className='text-[24px] font-semibold'>Shankh Score : <span className='text-[#F9A826]'>{selectedTest.overallScore}%</span></span>
            </div>
        ...
        <div style={{fontFamily : "Poppins"}} className='bg-white brightness-100 space-y-8 rounded-lg shadow-lg w-full pl-[24px] pt-[16px] pr-[24px] pb-[16px]'>
            ...
            <div className='grid grid-cols-2 gap-4'>
                <div className='bg-white shadow-xl rounded-lg pr-[25px] pb-[10px] pl-[25px] pt-[10px] '>
                    ...
                    <div>
                        <span className="text-[24px] font-semibold">{selectedTest.voiceInsights.fluency}%</span>
                ...
                <div className='bg-white shadow-xl rounded-lg pr-[25px] pb-[10px] pl-[25px] pt-[10px] '>
                    ...
                    <div>
                        <span className="text-[24px] font-semibold">{selectedTest.voiceInsights.clarity}%</span>
                        <div className="flex h-[10px] w-full rounded-l-full rounded-r-full bg-[#D9E0E6]">
                            <div
                ...
                <div className='bg-white shadow-xl rounded-lg pr-[25px] pb-[10px] pl-[25px] pt-[10px] '>
                    ...
                    <div>
                        <span className="text-[24px] font-semibold">{selectedTest.voiceInsights.toneModulation}%</span>
                        <div className="flex h-[10px] w-full rounded-l-full rounded-r-full bg-[#D9E0E6]">
                            <div
                ...
                <div className='bg-white shadow-xl rounded-lg pr-[25px] pb-[10px] pl-[25px] pt-[10px] '>
                    ...
                    <div>
                        <span className="text-[24px] font-semibold">{selectedTest.voiceInsights.fillerWords}%</span>
                        <div className="flex h-[10px] w-full rounded-l-full rounded-r-full bg-[#D9E0E6]">
                            <div
        ...
        <div style={{fontFamily : "Poppins"}} className='bg-white brightness-100 space-y-8 rounded-lg shadow-lg w-full pl-[24px] pt-[16px] pr-[24px] pb-[16px]'>
            ...
            <div className='grid grid-cols-2 gap-4'>
                <div className='bg-white shadow-xl rounded-lg pr-[25px] pb-[10px] pl-[25px] pt-[10px] '>
                    ...
                    <div>
                        <span className="text-[24px] font-semibold">{selectedTest.behaviorInsights.emotionalRegulation}%</span>
                        <div className="flex h-[10px] w-full rounded-l-full rounded-r-full bg-[#D9E0E6]">
                            <div
                ...
                <div className='bg-white shadow-xl rounded-lg pr-[25px] pb-[10px] pl-[25px] pt-[10px] '>
                    ...
                    <div>
                        <span className="text-[24px] font-semibold">{selectedTest.behaviorInsights.confidenceAndPresence}%</span>
                        <div className="flex h-[10px] w-full rounded-l-full rounded-r-full bg-[#D9E0E6]">
                            <div
                ...
                <div className='bg-white shadow-xl rounded-lg pr-[25px] pb-[10px] pl-[25px] pt-[10px] '>
                    ...
                    <div>
                        <span className="text-[24px] font-semibold">{selectedTest.behaviorInsights.pacingAndPauses}%</span>
                        <div className="flex h-[10px] w-full rounded-l-full rounded-r-full bg-[#D9E0E6]">
                            <div
                ...
                <div className='bg-white shadow-xl rounded-lg pr-[25px] pb-[10px] pl-[25px] pt-[10px] '>
                    ...
                    <div>
                        <span className="text-[24px] font-semibold">{selectedTest.behaviorInsights.engagement}%</span>
                        <div className="flex h-[10px] w-full rounded-l-full rounded-r-full bg-[#D9E0E6]">
                            <div
        ...
        <div className='bg-white brightness-100 space-y-8 rounded-lg shadow-lg w-full pl-[24px] pt-[16px] pr-[24px] pb-[16px]'>
            ...
            Thank you for this opportunity to speak about the importance of sustainable development. Um, today I'd like to share some thoughts on how we can implement green practices in our daily lives.

            <br></br><br></br>Um, first of all, I believe that sustainable development is crucial for the future of our planet. You know, we're facing unprecedented environmental challenges, from climate change to pollution and resource depletion. 

            <br></br><br></br>Like, for example, the recent report by the Climate Research Foundation indicates that we have less than a decade to make significant changes in our carbon emissions. Uh, this means we need to act now, not later.

            <br></br><br></br>Um, in my experience, small changes can lead to big impacts. For instance, reducing single-use plastic, conserving water, and using public transportation are all steps that um, individuals can take. You know, these might seem minor, but collectively they create substantial change.

            <br></br><br></br>I believe that uh, education plays a vital role in promoting sustainable behavior. Like, when people understand the consequences of their actions, they're more motivated to make positive changes.

            <br></br><br></br>In conclusion, um, sustainable development requires collective effort and individual commitment. Uh, thank you for your attention, and I'm happy to answer any questions you might have.
            </p>
        </div>
    </div>
