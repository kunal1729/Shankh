...
const Onboarding7 = () => {
    ...
    <div  className='flex flex-col space-y-4 justify-center items-center text-center'>
        ...
        <div style={{fontFamily : "Poppins"}} className='flex space-x-[20px]'>
            ...
            <NavLink className="bg-[#FF6B5B] text-white text-[18px] w-[210px] pt-[10px] pl-[53px] pb-[10px] rounded-lg pr-[53px]" onClick={() => setPage((prev) => prev + 1)} to={'/onboarding/step8'} >Continue</NavLink>
        </div>
