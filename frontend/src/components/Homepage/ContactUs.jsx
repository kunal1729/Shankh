  ...
  return (
    <div id='ContactUs' className='h-screen sticky top-0 z-0 rounded-t-2xl flex space-x-24 p-[64px] bg-[#34856C]'>
      <motion.div  className='w-[539px] brightness-75 shadow-lg grid content-end space-y-4 p-6 rounded-2xl  bg-cover' style={{ backgroundImage: `url(${blog1})`, x : x }}>
        ...
        <button style={{fontFamily : "Poppins"}} className='border w-[199px] hover:bg-[#34856C] cursor-pointer hover:text-white rounded-lg font-semibold pt-[10px] text-[16px] pb-[10px] pl-[53px] pr-[53px] text-white border-white'>Learn More</button>
      </motion.div>
      <ContactForm/>
    </div>
  )
